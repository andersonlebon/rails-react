...
# create the messages_controller.rb file in the app/controllers/api/v1 folder
# add the following code to the messages_controller.rb file
...
# create the messages_controller_test.rb file in the test/controllers folder
# add the following code to the messages_controller_test.rb file
# require 'test_helper'
# 
